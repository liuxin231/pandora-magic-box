...
import { selectAppSettings, toggleTheme } from "@/store/settings";
...
const ThemeSwitch = () => {
  ...
  let [themeValue, setThemeValue] = useState(appSettingState.theme === "dark"? true:false);
  const changeSwitch = (event: React.ChangeEvent<HTMLInputElement>) => {
    setThemeValue(event.target.checked);
    let theme = "dark";
